...
"#,
    ...
    assert!(candidates.contains("ticket:search list get create update comment comments tag untag link unlink links link-types attach attachments log worklog set fields history sprints delete"));
